...
/**
 * 💡 最终全适配修复说明：
 * 1. 移动端适配：增加了大量的响应式断点（sm, md, lg），确保手机端排版整齐。
 * 2. 链接调用：视频和画廊图片全部直接调用腾讯云 COS，实现极致加载速度。
 * 3. 格式兼容：针对 07, 08, 09, 10, 13 使用 .png，其余 .jpg。
 * 4. 交互：增加了侧边显性滚动条，Logo 统一为 H。
 */
...
const UE_PROJECTS = [
  {
    ...
    description: '从方案设计到最终资源优化全流程参与。【一共11个案例，不小心多选了一个，嘿嘿】',
    timestamps: [
  ...
  },
  {
    ...
    timestamps: [
      ...
      { time: 45, label: '最后的生还者', icon: '⑨' }, { time: 68, label: '自然洞穴', icon: '⑩' },
  ...
  return (
    <div className="min-h-screen bg-[#0d0f0e] text-emerald-50 font-sans selection:bg-emerald-500/30 overflow-x-hidden text-left">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute inset-0 bg-soft-stars-green opacity-[0.12]"></div>
        ...
        <div className={`fixed inset-0 z-[100] bg-[#0d0f0e] flex flex-col items-center justify-center transition-all duration-[800ms] ease-in-out ${isExiting ? 'opacity-0 scale-110 pointer-events-none' : 'opacity-100 scale-100'}`}>
          ...
          <div className="z-10 text-center space-y-8 px-6">
            <div className="space-y-4">
              ...
              <p className="text-emerald-100/40 max-w-xl mx-auto text-xs md:text-base font-medium tracking-widest text-center">
                感谢来访，欢迎交个朋友。
              </p>
            </div>
            <button 
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
                  ...
                  <div className="md:col-span-8 px-2">
                     <div className="bg-[#141816] rounded-[2.5rem] md:rounded-[3rem] shadow-2xl overflow-hidden border border-white/5">
                        ...
                        <div className="aspect-[1/1.4] bg-[#fafcfb] overflow-hidden shadow-inner h-[500px] md:h-auto">
                    ...
                    <div className="space-y-2 overflow-y-auto custom-scrollbar pr-2 max-h-[300px] md:max-h-[450px]">
                      {selectedVideo.timestamps.map((item, idx) => (
                        <button
                          ...
                          className="w-full flex items-center justify-between p-3 md:p-4 rounded-2xl md:rounded-3xl bg-white/5 hover:bg-emerald-600 text-emerald-100 hover:text-white transition-all text-left group shadow-sm"
                        >
            ...
            {activeTab === 'gallery' && (
              <div className="space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out text-left text-emerald-50">
                 <div className="flex items-center gap-4 mb-4 md:mb-10 px-2 md:px-4 text-left">
                   <h3 className="text-xl md:text-3xl font-black italic tracking-tighter uppercase text-emerald-100 italic text-left">🍃 Sketches / 不正经的随笔</h3>
              ...
              <div className="max-w-4xl mx-auto animate-in zoom-in-95 duration-700 px-4 py-8 md:py-12 text-emerald-50 text-center">
                 <div className="text-center space-y-10 md:space-y-12">
                   <div className="space-y-4 text-center">
                     ...
                     <p className="text-emerald-100/40 font-medium max-w-2xl mx-auto leading-relaxed text-center underline decoration-emerald-500/20 underline-offset-8 text-xs md:text-base text-center">如果您对我的作品感兴趣，或者想合作，欢迎联系我。</p>
                   </div>
                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-3xl mx-auto text-center">
                      <div className="flex flex-col items-center gap-4 md:gap-6 p-8 md:p-10 bg-[#141816] rounded-[2.5rem] border border-emerald-900/10 group hover:bg-emerald-500/5 transition-all shadow-lg text-center">
                        ...
                        <div className="text-center">
                          <p className="text-[10px] md:text-[12px] text-emerald-300/40 uppercase font-black tracking-[0.2em] mb-1 text-center">Email 邮箱</p>
                          <p className="text-lg md:text-xl font-bold text-emerald-100 text-center">1905878535@qq.com</p>
                        </div>
                      </div>
                      <div className="flex flex-col items-center gap-4 md:gap-6 p-8 md:p-10 bg-[#141816] rounded-[2.5rem] border border-emerald-900/10 group hover:bg-emerald-500/5 transition-all shadow-lg text-center">
                        ...
                        <div className="text-center">
                          <p className="text-[10px] md:text-[12px] text-emerald-300/40 uppercase font-black tracking-[0.2em] mb-1 text-center">WeChat 微信</p>
                          <p className="text-lg md:text-xl font-bold text-emerald-100 text-center">15800955272</p>
                        </div>
                      </div>
                   </div>
                 </div>
          ...
          <footer className="border-t border-white/5 py-12 md:py-16 relative z-10 bg-[#0d0f0e]/50 text-center md:text-left text-emerald-50">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8 text-left">
              <div className="flex items-center gap-4 text-left">
                <div className="w-8 h-8 bg-emerald-600 text-white text-xs font-black flex items-center justify-center rounded-full shadow-lg shadow-emerald-500/10 text-left">H</div>
